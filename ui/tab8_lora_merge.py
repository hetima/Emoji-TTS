            ...
            with gr.Tab("通常LoRAマージ"):
                ...
                with gr.Accordion("出力設定", open=True):
                    ll_output_dir = gr.Textbox(
                        label="保存先フォルダ（空欄=" + str(cnfg.lora_dir) + "/lora_merged_*/）",
                        value="",
                        placeholder=str(cnfg.lora_dir / "lora_merged_*"),
                    )
                ...
                with gr.Accordion("アダプタA（必須）", open=True):
                    with gr.Row():
                        ...
                        lm_scale_a1 = gr.Slider(
                            label="scale", minimum=0.0, maximum=2.0, value=1.0, step=0.05, scale=2
                        )
                ...
                with gr.Accordion("出力設定", open=True):
                    with gr.Row():
                        ...
                        lm_output_dir = gr.Textbox(
                            ...
                            value="",
                            placeholder=str(cnfg.checkpoints_dir / "lora_merged"),
                            scale=3,
                        )
